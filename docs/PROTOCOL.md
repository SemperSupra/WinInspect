...
1. **Server $\rightarrow$ Client**: `{"type":"hello","version":"0.1.2","nonce":"<b64>","pubkey":"<b64_ecdh_pub>"}`
2. **Client $\rightarrow$ Server**: `{"version":"0.1.2","identity":"<user>","signature":"<b64_ssh_sig>","pubkey":"<b64_ecdh_pub>"}`
